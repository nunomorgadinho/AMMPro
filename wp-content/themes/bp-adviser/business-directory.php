  ...
  <div id="content" class="hfeed">
    <form class="wpsc_checkout_forms" enctype="multipart/form-data" method="post" action="<?php echo get_bloginfo('siteurl').'/new-business/'; ?>">        
        <section>
            ...
            <li class="busdiradd"><input type="submit" class="submit bright" value="Add new Business" /></li>
    ...
    <?php 
		$deals = new WP_Query();
	    $deals->Query('post_type=businessentry&post_status=publish&posts_per_page=-1');			        
		if ( $deals->have_posts() ) : 
	?>
