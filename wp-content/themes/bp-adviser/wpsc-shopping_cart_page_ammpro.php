  ...
  */
  if(wpsc_uses_shipping()): ?>
   ...
   <?php do_action('wpsc_before_form_of_shopping_cart'); ?>
	...
	<?php endif; ?>	
	<form id='wpsc_home_checkout_form' class='wpsc_checkout_forms' action='<?php echo get_option('shopping_cart_url'); ?>' method='post' enctype="multipart/form-data">
      ...
      <?php /* if(wpsc_gateway_count() > 1): // if we have more than one gateway enabled, offer the user a choice ?>
         ...
         <td colspan='2' class='wpsc_gateway_container'>
            ...
            <?php while (wpsc_have_gateways()) : wpsc_the_gateway(); 
            		if (strcmp(wpsc_gateway_internal_name(),'wpsc_merchant_paypal_standard')===0): ?>
               <div class="custom_gateway">
                     <label><input type="radio" value="<?php echo wpsc_gateway_internal_name();?>"  checked="checked"  <?php // echo wpsc_gateway_is_checked(); ?> name="custom_gateway" class="custom_gateway"/><?php echo wpsc_gateway_name(); ?> 
...
<!-- div for make purchase button -->
      <div class='wpsc_make_purchase'>
         <span>
            ...
            <?php endif; ?>
            	<input type='hidden' value="wpsc_merchant_paypal_standard" name="custom_gateway" />
               	<input type='hidden' value='submit_checkout' name='wpsc_action' />
               	<!--  <input type='submit' value='<?php _e('CREATE MY ACCOUNT ', 'wpsc');?>' name='submit1' class='make_purchase wpsc_buy_button' /> -->
         </span>
      </div>
