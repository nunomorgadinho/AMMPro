...
?>
   ...
   */
   ...
   <?php do_action('wpsc_before_form_of_shopping_cart'); ?>
	...
	<?php endif; */?>	
	<form id='wpsc_home_checkout_form' name='wpsc_home_checkout_form' class='wpsc_checkout_forms' action='<?php echo get_option('shopping_cart_url'); ?>' method='post' enctype="multipart/form-data">
		...
		<tr>
         <td colspan='2' class='wpsc_gateway_container'>
            ...
            <?php while (wpsc_have_gateways()) : wpsc_the_gateway(); 
            		if (strcmp(wpsc_gateway_internal_name(),'wpsc_merchant_paypal_pro')===0):  // herb - only show paypal pro gateway and no radio buttons ?>
      ...
      <div class='wpsc_make_purchase'>
         <span>
            ...
            <?php endif; ?>
               ...
               <input type='hidden' value='<?php _e('Purchase', 'wpsc');?>' name='submit' />
               <?php /* <input type='submit' value='<?php _e('Purchase', 'wpsc');?>' name='submit' class='make_purchase wpsc_buy_button' /> */ ?> 
         </span>
      </div>
