...
<h2><div class="icon32" id="icon-users"><br /></div><a href="admin.php?page=wpec_members&tab=wpec_manage_members" class=" nav-tab nav-tab-active">Manage Suscribers</a>
		<a href="admin.php?page=wpec_members&tab=wpec_manage_subscriptions" class="nav-tab">Manage Subscriptions</a>
		<a href="admin.php?page=wpec_members&tab=wpec_manage_settings" class="nav-tab">Settings</a></h2>
...
function wpec_members_display_manage_settings_tabs(){
	global $wpsc_product_capability_list;
	?>
<h2><div class="icon32" id="icon-users"><br /></div><a href="admin.php?page=wpec_members&tab=wpec_manage_members" class=" nav-tab ">Manage Suscribers</a>
<a href="admin.php?page=wpec_members&tab=wpec_manage_subscriptions" class="nav-tab">Manage Subscriptions</a>
<a href="admin.php?page=wpec_members&tab=wpec_manage_settings" class="nav-tab nav-tab-active">Settings</a></h2>
...
function wpec_members_display_wpec_edit_member(){
	...
	wpec_members_display_manage_subscribers_tabs(); 
	?>
...
<h2><div class="icon32" id="icon-tools"><br /></div><a href="admin.php?page=wpec_members&tab=wpec_manage_members" class=" nav-tab">Manage Suscribers</a>
		<a href="admin.php?page=wpec_members&tab=wpec_manage_subscriptions" class="nav-tab nav-tab-active">Manage Subscriptions</a>
		<a href="admin.php?page=wpec_members&tab=wpec_manage_settings" class="nav-tab">Settings</a></h2>
...
function wpec_members_display_manage_settings()
{
	...
	<div class="wrap">
		...
		<form id="members-settings" method="post" action="">
			...
			<tbody>
			<tr valign="top">
			<th scope="row">End of the Subscription</th>
			<td><fieldset>
			<p>Configure the e-mail that is sent at the end of the subscription.</p>
			<p>
			Subject: <input type="text" name="subscription_end_email_subject" id="subscription_end_email_subject" class="large-text" value="<?php echo $subscription_end_email_subject; ?>"></input>
			Message:
			<textarea name="subscription_end_email" rows="10" cols="50" id="subscription_end_email" class="large-text code"><?php echo $subscription_end_email; ?></textarea>
			</p>
			</fieldset></td>
			</tr>
			<tr valign="top">
			<th scope="row">Buyer's Recurring E-mail</th>
			<td><fieldset>
			<p>Configure the e-mail that is sent when the subscription is billed.</p>
			<p>
			Subject: <input type="text" name="subscription_recurring_email_subject" id="subscription_recurring_email_subject" class="large-text" value="<?php echo $subscription_recurring_email_subject; ?>"></input>
			Message:
			<textarea name="subscription_recurring_email" rows="10" cols="50" id="subscription_recurring_email" class="large-text code"><?php echo $subscription_recurring_email; ?></textarea>
			</p>
			</fieldset></td>
			</tr>
			</tbody>
