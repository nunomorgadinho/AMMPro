...
<!--
    ...
    <div class="bbpress-homeset">
        <a href="<?php bp_loggedinuser_link() ?>" id="bbhome">Home</a>
        <a href="<?php bp_loggedinuser_link() ?>settings/" id="bbsettings">Settings</a>
    </div>
	<h2 class="line block6"><?php printf( __( "What's new %s?", 'buddypress' ), bp_get_user_firstname() ) ?></h2>
     <!--<div class="item-title"><a href="<?php bp_loggedinuser_link() ?>">
              < ?php bp_group_name() ?>Profile
              </a></div>-->
