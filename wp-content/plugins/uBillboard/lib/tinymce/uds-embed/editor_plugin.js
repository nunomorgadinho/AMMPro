...
(function() {
	...
	tinymce.create('tinymce.plugins.udsEmbed', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addButton('udsEmbed', {
				title : 'Embed any content in uBillboard',
				cmd : 'mceEmbed',
			...
			ed.onNodeChange.add(function(ed, cm, e, collapsed) {
				//cm.setDisabled('udsEmbed', collapsed);
			});
		},
	...
	// Register plugin
	tinymce.PluginManager.add('udsEmbed', tinymce.plugins.udsEmbed);
})();